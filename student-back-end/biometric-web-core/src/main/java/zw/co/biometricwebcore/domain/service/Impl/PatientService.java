...
//        }
    ...
    public void updateEnrollmentStatus(String membership,String enrollmentStatus) {
        Optional<Patient> byPersonnelNumber = patientRepository.findByPersonnelNumber(membership);
        byPersonnelNumber.get().setEnrolmentStatus(enrollmentStatus);
        patientRepository.save(byPersonnelNumber.get());
    }
    ...
    public void updateEnrollmentStatusDependant(String membership,String enrollmentStatus, int suffix) {
        Optional<Dependant> byPersonnelNumberAndSuffix = dependantRepository.findByPersonnelNumberAndSuffix(membership,suffix);
        byPersonnelNumberAndSuffix.get().setEnrolmentStatus(enrollmentStatus);
        dependantRepository.save(byPersonnelNumberAndSuffix.get());
    }
    ...
    public ResponseEntity<BaseResult> getDependantByPersonnelAndSuffix(String personnelNumber, int suffix) {
        Optional<Dependant> dependants = dependantRepository.findByPersonnelNumberAndSuffix(personnelNumber,suffix);
