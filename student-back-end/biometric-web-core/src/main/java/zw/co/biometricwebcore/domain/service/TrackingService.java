...
public class TrackingService {
    ...
    public List<StudentAccessEvent> getEventsBetween(String reg, LocalDateTime from, LocalDateTime to) {
        if(reg == null || reg.isBlank()) {
            return eventRepository.findAllByTime(from, to);
        }
        return eventRepository.findAllBetween(reg, from, to);
    }
}
