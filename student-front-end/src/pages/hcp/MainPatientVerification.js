...
const MainPatientVerification = () => {
    ...
    // const matchScore = () => {
    //     console.log(fingerPrintFromTheScannerDevice)
    //     console.log(fingerPrintFromTheDatabase)
    //     if (!fingerPrintFromTheScannerDevice || !fingerPrintFromTheDatabase) {
    ...
    //         template2: encodeURIComponent(fingerPrintFromTheDatabase),
    //         licstr: encodeURIComponent(secugen_lic),
    //         templateFormat: "ISO",
    //     });
    ...
    const succMatch = async (result) => {
        ...
        if (result.ErrorCode === 0) {
            ...
            if (result.MatchingScore >= 50) {
                toast.success(`Fingerprints for ${firstName} ${lastName} matched successfully`); // Successful match
                // Optionally, navigate to another page or reset the page here
            } else {
                toast.error(`Fingerprints for ${firstName} ${lastName} did not match!`); // Failed match
            ...
            <div className="p-4">
                ...
                <div className="bg-gray-200 p-4" style={{ borderRadius: '20px', paddingBottom: '70px', paddingTop: '70px', paddingLeft: '50px', marginTop: '30px' }} >
                    ...
                    <div className="grid grid-cols-2 gap-1" > {/* Reduced gap to 2 */}
                        ...
                        <p className="text-lg">{patient.personnelNumber}-00</p>
...
export default MainPatientVerification;